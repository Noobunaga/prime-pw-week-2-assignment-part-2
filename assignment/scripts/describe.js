...
// We made a variable called name and set the value as Dane.
// We check to see if name is the exact match to Mary.
// If it is we console.log 'Hi, Mary!', If not we console. log 'How do you do?'.
